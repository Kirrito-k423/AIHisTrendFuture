...
const architectureOverrides: Record<string, string> = {
  ...
  "deepseek-v4-flash-vision-exp": "V4-Flash family VLM + vision encoder / aligner + DSpark",
  ...
  "gpt-5-6-cyber": "GPT-5.6 cyber-specialized model + Daybreak Red",
  "claude-zeta-research": "Internal Claude research model + zeta zeros + Lean",
  "grok-4-6": "Closed API + long-running agents + Cursor day-0",
  ...
  "ling-3-0-flash": "Hybrid-linear MoE + KDA / Gated MLA",
  "claude-opus-5": "Claude 5 API · adaptive thinking · 1M context",
  "claude-fable-5-1": "Claude 5.1 API · adaptive thinking · 1M context · fallback safeguards",
  "glm-45": "Sparse MoE",
  ...
  "minimax-music-3-0": "8-layer RVQ + global-local Hybrid-LM + Flow-VAE",
  ...
  "ltx-25": "Joint audio-video world model · multi-shot + restoration",
  "cosmos3-super": "AR Reasoner + Rectified-Flow Generator · Mixture of Transformers",
  "cosmos3-edge": "4B Edge World Model · MoT + Action",
...
const historyEventIdByCatalogId: Partial<Record<string, string>> = {
  ...
  "qwen-audio-30-tts-plus": "qwen-audio-3-0-tts-plus",
  "kimi-k26": "kimi-k2-6",
  "deepseek-v4-pro": "deepseek-v4-pro",
  "deepseek-v4-flash-0731": "deepseek-v4-flash-0731",
  "deepseek-v4-flash-vision-exp": "deepseek-v4-flash-vision-exp",
  "openai-astra-internal": "openai-astra-internal",
  ...
  "dots3-note-prev": "dots3-note-prev",
