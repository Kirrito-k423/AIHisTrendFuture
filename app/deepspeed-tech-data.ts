...
function august27DeepSpeedSource(
  id: string,
  title: string,
  url: string,
): Source {
  return {
    ...
    url,
    type: "代码仓",
    accessedAt: AUGUST_27_DEEPSPEED_ACCESS_DATE,
  };
}
...
const mpsZeroSupport = deepSpeedEvent({
  ...
  extraSources: [
    ...
    august27DeepSpeedSource(
      "deepspeed-mps-fusedadam-cpuadam-commit",
      "[Apple Silicon Support Phase 1] Add Metal FusedAdam kernel and CPU Adam build for Apple Silicon",
      "https://github.com/deepspeedai/DeepSpeed/commit/715965e027894a2e72ac2e27f2daed2c599e99f0",
    ),
    august27DeepSpeedSource(
      "deepspeed-mps-fusedadam-cpuadam-pr",
      "[Apple Silicon Support Phase 1] Add Metal FusedAdam kernel and CPU Adam build for Apple Silicon",
...
const autoTp = deepSpeedEvent({
  ...
  extraSources: [
    ...
    {
      id: "deepspeed-autotp-zero3-training-commit",
      title: "[AutoTP] Fix ZeRO-3 checkpoint consolidation to gather across TP and DP",
      publisher: "deepspeedai/DeepSpeed",
      url: "https://github.com/deepspeedai/DeepSpeed/commit/eec237ee892901f4f239bb23cfe2cfbd85f4dc3b",
      type: "代码仓",
      accessedAt: "2026-08-03",
    },
    {
      id: "deepspeed-examples-autotp-smoke-commit",
      title: "Add AutoTP=2 smoke test config and script",
      publisher: "deepspeedai/DeepSpeedExamples",
      url: "https://github.com/deepspeedai/DeepSpeedExamples/commit/c230e2da774ce2fcfee1c0d92733e9566d2336fe",
      type: "代码仓",
